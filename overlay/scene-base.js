...
(function (global) {
  ...
  function demoState() {
    return {
      ...
      eventName: 'JOTA INVITATIONAL — GRAND FINAL',
  ...
  const STANDALONE_CASTER_RE = /\/(casters|duorow|triorow|duosinglecam|triocam|awayfull|analystspecial)\.html$/i;
  ...
  const SceneBase = {
    ...
    connect(onState) {
      ...
      const _cache = {};
      const BACKFILL_KEYS = ['brand', 'banner', 'mainBanner', 'brandKits'];
      const open = () => {
