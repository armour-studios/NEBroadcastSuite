...
Para tener el mismo aspecto que en las capturas, deberás descargar la fuente **Bourgeois**.
...
3.  El archivo resultante aparecerá en la carpeta **`dist/`** como `NE-Broadcast-Suite.exe`.
